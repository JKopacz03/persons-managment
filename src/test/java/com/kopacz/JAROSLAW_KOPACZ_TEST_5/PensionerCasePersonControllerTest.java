...
public class PensionerCasePersonControllerTest {
    ...
    @Autowired
    public PensionerCasePersonControllerTest(MockMvc mockMvc, ObjectMapper objectMapper, JwtService jwtService, DatabaseUtils databaseUtils, JobExplorer jobExplorer) {
